...
import Mottaz from "../Assets/MOTTAZ.svg";
import Img from "../Assets/Ellipse.svg";
import Img01 from "../Assets/Property.svg";
import Sd3 from "../Assets/new/sd-3.jpg";
import Gear from "../Assets/assets.svg";
        ...
        <>
            ...
            <div className={"container"}>
                <div className={"row"}>
                    <div className={"col-md-4"}>
                        <div className={"box-card"}>
                            ...
                            <p className={"fw-bold"}>Modern Strategy</p>
                            <p>Accron Revolutions is a smart approach company provides Cutting egde services to the
                                clients</p>
                        </div>
                    </div>
                    ...
                    <div className={"col-md-4"}>
                        <div className={"box-card"}>
                            ...
                            <p className={"fw-bold"}>Best Relationship</p>
                    ...
                    <div className={"col-md-4"}>
                        <div className={"box-card"}>
                            ...
                            <p className={"fw-bold"}>Ultimate Marketing</p>
                            <p>Your Dreams are our passions</p>
                        </div>
                    </div>
                </div>
                <div className={"d-flex justify-content-center position-relative"}>
                    <div className={"box-card mt-5 w-530"}>
                ...
                <div className={"my-5 pb-5"}>
                    <h1 className={"my-5"}> What is Our <span>Strength</span></h1>
                </div>

                <div className={"mt-5 text-center"}>
                    <h1>Trusted by Brand</h1>
                    <div className={"d-flex mt-5 justify-content-center mb-5"}>
                ...
                <div>
                    <div className={"row justify-content-center mt-5"}>
                        <div className={"col-md-6"}>
                            <h1 className={"text-center"}>High-Quality Solutions</h1>
                            <p style={{textAlign: "justify"}} className={"mt-4"}>We understand that our clients entrust
                                us with their sensitive information and rely on us to deliver high-quality solutions.
                                That's why we prioritize transparency and open communication throughout the development
                                process. We keep our clients informed of our progress and address any concerns
                                promptly</p>
                        </div>
            ...
            {/*/!*    <br/>*!/*/}
            {/*/!*    <title>Accron Revolutions</title>*!/*/}
            {/*/!*    <p class="fw-bold fs-4 text-white text-center">*!/*/}
            {/*/!*        {" "}*!/*/}
            {/*/!*        Accron Revolutions Private Limited is a leading provider of digital sollutions, specializing in*!/*/}
            {/*/!*        mobile app development, website development and digital markrting services.*!/*/}
            {/*/!*    </p>*!/*/}
            {/*/!*    <br/>*!/*/}
            {/*/!*    <div class="container">*!/*/}
            {/*/!*        <div class="row">*!/*/}
            ...
            {/*/!*                            <p>Contact us immediately if you have a question in mind <br></br>*!/*/}
            {/*/!*                            </p>*!/*/}
            {/*/!*                        </div>*!/*/}
            {/*/!*                    </div>*!/*/}
